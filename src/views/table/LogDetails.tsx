      ...
      <TimelineItem>
        ...
        <TimelineContent sx={{ '& svg': { verticalAlign: 'bottom', mx: 4 } }}>
          ...
          <Box sx={{ mt: 2, display: 'flex', alignItems: 'center' }}>
            <img width={28} height={28} alt='invoice.pdf' src='/sneat-mui-react-nextjs-admin-template/demo-1/images/icons/file-icons/pdf.png' />
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex' }}>
              <Avatar src='/sneat-mui-react-nextjs-admin-template/demo-1/images/avatars/2.png' sx={{ width: '2rem', height: '2rem', mr: 2 }} />
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Box sx={{ mb: 3, display: 'flex', flexDirection: { sm: 'row', xs: 'column' } }}>
            <ImgShoe width='85' height='85' alt='Shoe img' src='/sneat-mui-react-nextjs-admin-template/demo-1/images/misc/shoe.jpeg' />
            <Box sx={{ ml: { sm: 3, xs: 0 } }}>
              <Box
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Avatar src='/sneat-mui-react-nextjs-admin-template/demo-1/images/avatars/1.png' sx={{ width: '2rem', height: '2rem', mr: 2 }} />
            <Typography variant='subtitle2' sx={{ fontWeight: 600 }}>
              John Doe (Client)
            </Typography>
          </Box>
