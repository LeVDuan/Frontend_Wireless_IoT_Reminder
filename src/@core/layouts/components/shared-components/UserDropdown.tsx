      ...
      >
        <Box sx={{ py: 2, px: 4 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <Avatar alt='Duan Le' src='/images/avatars/DuanLV.jpg' sx={{ width: '2.5rem', height: '2.5rem' }} />
            </Badge>
            <Box sx={{ ml: 3, display: 'flex', alignItems: 'flex-start', flexDirection: 'column' }}>
              <Typography sx={{ fontWeight: 500 }}>Duan Le</Typography>
